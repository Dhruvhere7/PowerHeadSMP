...
execute if score @s wasd.song_id matches 20.. run scoreboard players set @s wasd.song_id 1
...
execute if score @s wasd.song_id matches 17 run playsound minecraft:music_disc.precipice record @s ~ ~ ~ 1000000 1
execute if score @s wasd.song_id matches 17 run title @s actionbar {"text":"Now playing: Aaron Cherof - Precipice","color":"dark_purple"}
execute if score @s wasd.song_id matches 18 run playsound minecraft:music_disc.creator record @s ~ ~ ~ 1000000 1
execute if score @s wasd.song_id matches 18 run title @s actionbar {"text":"Now playing: Lena Raine - Creator","color":"dark_purple"}
execute if score @s wasd.song_id matches 19 run playsound minecraft:music_disc.creator_music_box record @s ~ ~ ~ 1000000 1
execute if score @s wasd.song_id matches 19 run title @s actionbar {"text":"Now playing: Lena Raine - Creator (Music Box)","color":"dark_purple"}