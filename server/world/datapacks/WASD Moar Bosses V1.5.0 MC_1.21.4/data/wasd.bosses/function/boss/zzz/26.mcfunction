...
execute anchored eyes positioned ^ ^ ^1.5 facing entity @p eyes run function wasd.bosses:boss/zzz/27
...
execute as @s[tag=wasd.has_los] facing entity @p feet run function wasd.bosses:boss/zzz/29
