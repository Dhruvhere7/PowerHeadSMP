...
execute anchored eyes positioned ^ ^ ^1.5 facing entity @p eyes run function wasd.bosses:boss/zzz/44
...
execute as @s[tag=wasd.has_los] anchored eyes positioned ^ ^ ^0.1 facing entity @p feet run function wasd.bosses:boss/zzz/46
