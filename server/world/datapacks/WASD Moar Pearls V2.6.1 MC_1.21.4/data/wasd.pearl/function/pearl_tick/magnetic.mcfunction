...
particle dust{color:[1.000, 0.000, 0.000], scale:2.0} ~ ~ ~ 0.05 0.05 0.05 1 2 force
...
execute as @s[tag=!wasd.uuid_stored] run function wasd.pearl:pearl_tick/zzz/13
...
execute as @s[tag=!wasd.pearl_exists] run function wasd.pearl:pearl_tick/zzz/14