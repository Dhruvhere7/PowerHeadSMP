...
execute anchored eyes positioned ^ ^ ^0.01 run execute positioned ^-0.35 ^0.4 ^0.4 as @e[tag=wasd.lib_entity_tick,tag=wasd.ability,tag=wasd.wind,sort=nearest,limit=1] run data modify entity @s Rotation set from entity @p[scores={wasd.wand_click=1..,wasd.wand_type=12}] Rotation
